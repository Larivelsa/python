...
# FROM: a partir de# LEFT JOIN: valores que dão match em ambas colunas e também todas as linhas da tabela que estiverem à esquerda do comando
...
# também serão selecionados (no caso, é a tabela 'autor'). Ou seja, mesmo que autor
# não tenha relação com 'livro', todas as linhas também aparecerão no SELECT
