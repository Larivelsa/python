...
'''
quilos = float(input("Informe a quantidade de peixes em quilos: "))

if(quilos > 50):
    execedente = quilos - 50
    multa = execedente * 4
    print(f"Foi excedida a quantidade de {execedente} e o valor da multa é de R${multa:.2f}")
else:
    print(f"A quantidade de {quilos} quilos pescados não excede a diária e não há multa.")
